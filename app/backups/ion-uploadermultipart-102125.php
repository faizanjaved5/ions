...
function generateR2PresignedUrl($objectKey, $uploadId, $partNumber, $r2Config) {
    ...
    error_log("   Upload ID: " . substr($uploadId, 0, 20) . "...");
    error_log("   Canonical Query (first 100): " . substr($canonicalQueryString, 0, 100) . "...");
    error_log("   Signature: " . substr($signature, 0, 16) . "...");
    error_log("   URL (first 150 chars): " . substr($presignedUrl, 0, 150) . "...");
