...
function updateCaptureButtonVisibility() {
    ...
    if (generateBtn) {
        // Show for both local files AND imports (user can capture frame from embedded player)
        // Only hide for edit mode without permission
        if (window.editVideoData && !window.editVideoData.can_capture) {
            generateBtn.style.display = 'none';
            console.log('🎬 Capture button hidden (edit mode without permission)');
        } else {
