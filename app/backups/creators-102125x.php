...
<head>
    ...
    .videos-table-container {
        ...
        gap: 12px !important;
        overflow: visible !important; /* CRITICAL: Remove all overflow restrictions to prevent double scroll */
        overflow-y: visible !important; /* Explicitly prevent vertical scrollbar */
        overflow-x: hidden !important; /* Only prevent horizontal scroll */
        width: 100% !important;
        max-width: 100% !important;
        height: auto !important; /* Ensure natural height */
        max-height: none !important; /* CRITICAL: No height restrictions */
        min-height: 0 !important; /* Remove any min-height */
        flex: none !important; /* Don't participate in flex layout that might restrict height */
    }
    ...
    .videos-table {
        ...
        height: auto !important; /* Ensure natural height */
        max-height: none !important; /* CRITICAL: No height restrictions */
        overflow: visible !important; /* Prevent table from creating scroll */
    }
    
    /* CRITICAL: Ensure tbody doesn't create scrollbars */
    .videos-table tbody {
        overflow: visible !important;
        max-height: none !important;
        height: auto !important;
        display: table-row-group !important; /* Keep default table display */
    }
    ...
    <script>
        ...
        function toggleView(viewType) {
            ...
            if (viewType === 'list') {
                ...
                // CRITICAL: Ensure no scrollbar on list view container - use setProperty with priority
                listView.style.setProperty('overflow', 'visible', 'important');
                listView.style.setProperty('overflow-y', 'visible', 'important');
                listView.style.setProperty('max-height', 'none', 'important');
                listView.style.setProperty('height', 'auto', 'important');
