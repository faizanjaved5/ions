...
<body data-theme="<?= $theme ?>" <?= $isIframe ? 'style="margin: 0; padding: 0;"' : '' ?>>
    ...
    <?php endif; ?>
            ...
            <div class="modal-footer">
                ...
                <?php else: ?>
                    ...
                    <!-- Progress Bar Container - Clean Professional Design with Detailed Tooltip -->
    ...
    $uploaderProJsPath = __DIR__ . '/ionuploaderpro2.js';  // RENAMED to break cache
    ...
    <script src="<?= $assetBase ?>ionuploaderpro2.js?v=<?= $uploaderProVersion ?>&nc=<?= $nuclearBust ?>"></script>         <!-- Advanced features (MUST LOAD FIRST!) -->
