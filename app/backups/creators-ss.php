                    ...
                    ?>
                        <div class="carousel-item">
                            ...
                            <div class="video-card-info">
                                ...
                                <div class="creator-handle-container" style="display: flex; align-items: center; justify-content: space-between; margin-top: 0.5rem; margin-bottom: 0.5rem; min-height: 24px;">
                                    <div style="display: flex; align-items: center; gap: 8px;">
