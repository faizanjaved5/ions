...
<head>
    ...
    <style>
        * {
        ...
        /* Expand container when cart is open */
        ...
        /* 3-column layout when cart is open */
        body.cart-open .main-layout {
            grid-template-columns: 0.9fr 0.9fr 480px;
            gap: 15px;
        }
        ...
        /* Right-Side Cart Panel - Now a grid column */
        .cart-panel {
            display: none;
            background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%);
            border-left: 2px solid rgba(178, 130, 84, 0.3);
            border-right: 2px solid rgba(178, 130, 84, 0.2);
            border-radius: 8px;
...
<body>
    <div class="modal-container" style="width:100%;height:100vh;margin:0;padding:0;border-radius:0;overflow:hidden;display:flex;flex-direction:column;">
        ...
        <div class="main-layout">
            ...
            <!-- Third Column: Distribution Cart (appears when items added) -->
