...
<body data-theme="<?= $theme ?>" <?= $isIframe ? 'style="margin: 0; padding: 0;"' : '' ?>>
    ...
    <?php $cacheBuster = 'v102_' . time() . '_' . rand(10000, 99999); ?>
    <script src="<?= $assetBase ?>ionuploader.js?<?= $cacheBuster ?>"></script>            <!-- Core functionality -->
    <script src="<?= $assetBase ?>ionuploaderpro.js?<?= $cacheBuster ?>"></script>         <!-- Advanced features (includes R2MultipartUploader) -->
    <script src="<?= $assetBase ?>celebration-dialog.js?<?= $cacheBuster ?>"></script>      <!-- Celebration dialog for successful uploads -->
    <script src="<?= $assetBase ?>channel-selector.js?<?= $cacheBuster ?>"></script>        <!-- Channel search and selection -->
