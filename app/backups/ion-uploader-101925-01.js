...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add class to both the iframe body and parent page body (if in iframe)
    try {
        // Add to current document
        document.body.classList.add('modal-open');
        console.log('✅ Added modal-open class to iframe body');
        
        // If in iframe, also add to parent
        if (window.parent && window.parent !== window) {
            window.parent.document.body.classList.add('modal-open');
            console.log('✅ Added modal-open class to parent body');
        }
    } catch (e) {
        console.log('ℹ️ Could not access parent document (cross-origin):', e.message);
    }
