...
function goBackToStep1() {
    ...
    if (backBtn) {
        ...
        console.log('✅ Back button reset to "Cancel"');
    }
}
...
function validatePlatformUrlDuplicate(url, platform) {
    const patterns = {
        youtube: /^(https?:\/\/)?(www\.)?(youtube\.com\/(?:watch\?v=|shorts\/)|youtu\.be\/)[a-zA-Z0-9_-]{11}/,
...
function startFileUpload() {
    ...
    .catch(error => {
        ...
        // Use custom alert for better formatting
        showCustomAlert('Upload Error', errorDisplay);
    });
}
...
// Capture Frame button - captures current frame from video player
function generateThumbnail() {
    ...
    if (video) {
        try {
            ...
            showUploadStatus('Thumbnail generated successfully!', 'success');
            setTimeout(() => {
...
// Show thumbnail confirmation badge
