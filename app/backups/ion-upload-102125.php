...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="<?= $assetBase ?>ion-upload.css?v=200&t=<?= time() ?>&bust=<?= md5(time() . rand()) ?>">
...
<body data-theme="<?= $theme ?>" <?= $isIframe ? 'style="margin: 0; padding: 0;"' : '' ?>>
    ...
    $uploaderJsPath = __DIR__ . '/ion-upload.js';
    ...
    <script src="<?= $assetBase ?>ion-upload.js?v=<?= $uploaderVersion ?>&nc=<?= $nuclearBust ?>"></script>            <!-- Core functionality -->
