...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" href="<?= $assetBase ?>ion-uploads.css?v=101&t=<?= time() ?>&bust=<?= md5(time() . rand()) ?>">
...
<body data-theme="<?= $theme ?>" <?= $isIframe ? 'style="margin: 0; padding: 0;"' : '' ?>>
    ...
    <?php endif; ?>
            ...
            <div class="modal-footer">
                ...
                <?php else: ?>
                    <!-- Upload Mode Footer: Back, Progress Bar, Next/Upload -->
                    <button type="button" class="btn btn-secondary" id="backBtn">
    ...
    $uploaderJsPath        = __DIR__ . '/ion-uploads.js';
    ...
    <script src="<?= $assetBase ?>ion-uploader.js?v=<?= $uploaderVersion ?>&nc=<?= $nuclearBust ?>"></script>            <!-- Core functionality -->
