...
function updateCaptureButtonVisibility() {
    ...
    // Hide for platform imports (YouTube, Vimeo, etc.) - thumbnail is auto-fetched
    if (currentSource === 'youtube' || currentSource === 'vimeo' || currentSource === 'dailymotion') {
        shouldShow = false;
        reason = 'platform import - thumbnail auto-fetched';
    }
