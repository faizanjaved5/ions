...
<body data-theme="<?= $theme ?>" <?= $isIframe ? 'style="margin: 0; padding: 0;"' : '' ?>>
    ...
    ?>
    <script src="<?= $assetBase ?>ionuploader.js?v=<?= $uploaderVersion ?>&bust=<?= rand() ?>"></script>            <!-- Core functionality -->
    <script src="<?= $assetBase ?>ionuploaderpro.js?v=<?= $uploaderProVersion ?>&bust=<?= rand() ?>"></script>         <!-- Advanced features (includes R2MultipartUploader) -->
    <script src="../share/enhanced-ion-share.js?v=<?= time() ?>&bust=<?= rand() ?>"></script>                          <!-- Enhanced Share System -->
    <script src="<?= $assetBase ?>celebration-dialog.js?v=<?= $celebrationVersion ?>&bust=<?= rand() ?>"></script>      <!-- Celebration dialog for successful uploads -->
    <script src="<?= $assetBase ?>channel-selector.js?v=<?= $channelSelectorVersion ?>&bust=<?= rand() ?>"></script>        <!-- Channel search and selection -->
