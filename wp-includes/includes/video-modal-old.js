// video-modal.js - DEBUG VERSION
// This version includes extensive debugging to identify why videos open in new tabs
// Version 1.5.2 (Debug Version with Console Logging)
...
(function() {
    ...
    // Modal Elements
    let modal, videoContainer, closeBtn, loading, errorDiv, currentPlayer = null;
    ...
    function openVideoModal(videoType, videoId, videoUrl, videoFormat, options = {}) {
        ...
        applyModalSize(mergedOptions.modalSize);
