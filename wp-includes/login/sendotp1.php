...
// ✅ CHECK IF AUTHORIZED USER (Using correct enum values)
try {
    ...
    // Check if user is blocked or has no valid role (using correct enum values)
    ...
    $valid_roles = ['Owner', 'Admin', 'Creator'];  // Explicitly define valid roles
