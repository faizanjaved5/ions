...
// Debug capture for directory access
...
if (!isset($_SESSION['user_email']) || empty($_SESSION['user_email'])) {
    ...
    @file_get_contents($debug_base . urlencode("DIRECTORY: NO SESSION - handling as API or page"));
...
@file_get_contents($debug_base . urlencode("DIRECTORY: User role check - Role: '$user_role'"));
...
if (!in_array($user_role, ['Owner', 'Admin'])) {
    ...
    @file_get_contents($debug_base . urlencode("DIRECTORY: ACCESS DENIED - Role '$user_role' not authorized"));
    ...
    @file_get_contents($debug_base . urlencode("DIRECTORY: Not Creator role, continuing with directory"));
}
