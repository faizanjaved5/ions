...
function getParentMenus($pdo) {
    $stmt = $pdo->query("SELECT * FROM IONMenus WHERE name IS NOT NULL AND TRIM(name) != '' ORDER BY id");
...
require_once __DIR__ . '/includes/navbar_scripts.php';